                ...
                <div class="bg-white rounded-lg p-8 max-w-md w-full mx-4 shadow-2xl">
                    <div class="text-center">
                        <div class="mb-4">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-2">IUCN API Key Required</h3>
                            <p class="text-gray-600 mb-4">Enter your IUCN Red List API token to access the database.</p>
                        </div>
                        
                        <div class="mb-4">
                            <label for="iucn-api-key-input" class="block text-sm font-medium text-gray-700 mb-2">API Token:</label>
                            <input 
                                type="password" 
...
async function getIUCN() {
    ...
    try {
        ...
        controlsContainer.innerHTML = `
            ...
            <div class="mt-6 mb-6 px-4">
                <div class="w-full mx-auto">
                    <label for="iucn-table-search" class="text-lg font-semibold text-gray-800 mb-2 block">
        ...
        createColumnFilters('TableResults', 'iucn-column-filters');
